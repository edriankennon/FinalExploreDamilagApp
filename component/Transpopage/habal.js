      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        <View style={styles.overviewContainer}>
          ...
          <Text style={styles.overviewText}>
            {showFullText
              ? "A habal-habal is a motorcycle-based public transportation system in Southeast Asia that's used to carry people and cargo. A modified motorcycle that can carry up to eight people and their luggage. The term habal-habal is a Cebuano word that means looks like mating because of the way passengers sit close together on the motorcycle."
              : "A habal-habal is a motorcycle-based public transportation system in Southeast Asia that's used to carry people and cargo..."}
          </Text>
